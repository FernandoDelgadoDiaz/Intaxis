...
import { opportunityDevelopmentRouter } from './routes/opportunity-development.js';
import { offerEnrichmentRouter } from './routes/offer-enrichment.js';

export const app = express();
export const BUILD_VERSION = '0.11.2-autonomous-enrichment-handoff';
...
app.use('/api', autonomyRouter, operationRouter, businessRouter, chatRouter, discoveryRouter, opportunityDevelopmentRouter, offerEnrichmentRouter, exportRouter);
