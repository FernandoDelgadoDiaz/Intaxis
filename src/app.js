...
export const BUILD_VERSION = '0.10.0-selected-opportunity-development';
...
app.use('/api', autonomyRouter, operationRouter, businessRouter, chatRouter, discoveryRouter, opportunityDevelopmentRouter, exportRouter);
