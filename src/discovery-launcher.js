...
function buildMission(context) {
  ...
  return [
    ...
    'Cada evidencia debe tener un propósito acotado: explicá qué demuestra y qué NO demuestra. Una oferta local de un sabor no demuestra que ese comercio use el mismo envase, ni que exista demanda cuantificada, ni que tenga ventas altas.',
    'Preferí siempre una URL profunda del producto, servicio o artículo exacto. Si la plataforma sólo permite enlazar la página general del comercio, conservá esa URL real pero marcala explícitamente como página del comercio; no la presentes como enlace directo al producto.',
    'Usá evidence_type con precisión: packaging o presentation para formato/presentación, trend para tendencia, price para precio, competitor para oferta competitiva y flavor para presencia de sabor/categoría. Evitá other cuando exista una categoría específica.',
    'Dentro de metadata de cada evidencia incluí evidence_role, source_specificity, proves y does_not_prove. evidence_role debe ser uno de local_offer, format_reference, visual_reference, trend_signal, price_observation, competitor_context o market_context. source_specificity debe ser exact_product, business_page, category_page, article, homepage o source_page.',
    'Para una fuente local que sólo confirma presencia del producto o sabor usá evidence_role=local_offer. Para una fuente que muestra realmente lata/envase/presentación usá format_reference. No mezcles ambos alcances.',
